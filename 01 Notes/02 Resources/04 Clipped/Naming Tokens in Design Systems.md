...
![Masthead image with abstract visualization](https://miro.medium.com/max/700/1*s41MELn-hTQxA3DTcZtNHg.png)

Design tokens have provided a visual foundation of many design systems since [Salesforce pioneered the concept in 2014](/salesforce-ux/living-design-system-3ab1f2280ef7). I wrote an [impassioned article on design tokens in 2016](/eightshapes-llc/tokens-in-design-systems-25dd82d58421), and my energy on the topic continues to grow. As systems of visual style spread across a widening landscape of components, platforms and outputs, design tokens — and their names — are increasingly important.
...
![Code, documentation, and design tools exhibiting design tokens.](https://miro.medium.com/max/700/1*1U_TxyGcAYtTvSEbTWibTg.png)
...
![Salesforce UX Token hierarchy (Ferrua & Rewis, Clarity 2019)](https://miro.medium.com/max/700/1*LJX4Lm0eBJkQJueLmAfYBw.png)

Salesforce UX Token hierarchy ([Ferrua & Rewis, Clarity 2019](https://t.co/MqLj7SQjlR?amp=1))
...
![Basic token examples](https://miro.medium.com/max/700/1*Z6BGvwr4YcxGw91wZFWQNw.png)
...
![Complicated token examples](https://miro.medium.com/max/700/1*LUBPlw8ULmGpicnaSycNkA.png)
...
![Token levels as columns, with associated examples](https://miro.medium.com/max/700/1*QW0vwniEYOyv1dRzGdhfSQ.png)
...
![Tokens presenting a primary action’s hover color, from Bloomberg, Salesforce, Orbit, Morningstar, Infor and Adobe](https://miro.medium.com/max/700/1*TJnlrM52KCT0alsgKPgGkg.png)

Tokens presenting a primary action’s hover color, from [Bloomberg](https://github.com/bloombergindustry/fishtank-colors/tree/master/colors), [Salesforce](https://www.lightningdesignsystem.com/design-tokens/), [Orbit](https://orbit.kiwi/design-tokens/), [Morningstar](https://designsystem.morningstar.com/visual-language/constants/), [Infor](https://design.infor.com/resources/design-tokens) and [Adobe](https://github.com/adobe/spectrum-css/tree/main/components/vars/css)
...
![Common categories with associated variant terms](https://miro.medium.com/max/700/1*Zpkotgo9ul490WjxRmx6_g.png)
...
![Category/property example pairs](https://miro.medium.com/max/700/1*F6Vgc5iqVAQ5rqCB79cAqA.png)
...
![Concept level examples](https://miro.medium.com/max/700/1*MHHGGGTPXyLtm-yHG4MJqA.png)

![Concept level examples](https://miro.medium.com/max/700/1*I8jWE0hlFoqr7KD8QZ0OpQ.png)
...
![Concept level examples](https://miro.medium.com/max/700/1*PxO8kVFY8ipOTyD885rA2g.png)
...
![Variant level examples](https://miro.medium.com/max/700/1*-Rbq00UA6RLpAKetwh4K1Q.png)
...
![State level example](https://miro.medium.com/max/700/1*rRk79sVEhRnlEG20QW98xw.png)
...
-   **T-shirt sizes**, starting with `small` (variants: `s`), `medium` (variants: `m`, `standard`, `base`, `default`) and `large` (variant: `l`) and expanding to `xl`, `xs`, and `xxxl`. Pro tip: Size ≠ space, so consider using proportion instead of t-shirts for space [despite what I said four years ago](/eightshapes-llc/space-in-design-systems-188bcbae0d62).
...
![Scale level example](https://miro.medium.com/max/700/1*4DhYnf5vsPUR0cXEx0nsxw.png)
...
![Scale level example, with two category / scale pairs](https://miro.medium.com/max/700/1*PshFCme3AhlJTHWwajFMBA.png)
...
![UI elements on a light and dark background](https://miro.medium.com/max/700/1*k2CvFlreD65dVBMDxoBQDQ.png)
...
![Color mode level token example](https://miro.medium.com/max/700/1*lKIl7bfrgh3RkbNPaCA0xw.png)
...
![Component level token example](https://miro.medium.com/max/700/1*fKHfxEUR8kL31oWByK0ANw.png)
...
![Component code editor highlighting a token.](https://miro.medium.com/max/700/1*K_VCA4gN6EW9yHwRQ1hMWw.png)
...
![Nested element token example](https://miro.medium.com/max/700/1*jNualTw5wMnmGiVr42gG8A.png)
...
![Variants of an input component, annotating border and icon color](https://miro.medium.com/max/700/1*43_3OSB1NipWj4YwoZbt3Q.png)
...
![Component group token example](https://miro.medium.com/max/700/1*3gdsIKOLV67oTnjXDT5Wiw.png)
...
![Input, Select, Checkbox and Radio with border and selected color annotated](https://miro.medium.com/max/700/1*bj_TOQRxg4anN6GzBoRKrA.png)
...
![Theme token level example](https://miro.medium.com/max/700/1*IOrK0xYeYQKmSy262bDIUA.png)
...
While I’ve not yet observed this in practice, I anticipate systems will scale to support ecosystems of tokens for [design system tiers](/eightshapes-llc/design-system-tiers-2c827b67eae1). A *domain* (aka *business unit*) level offers namespaces for a group to create, isolate, and distribute a set of tokens on their own beyond the set coming from the system’s core.

![Domain token level example](https://miro.medium.com/max/700/1*8MvghL_PqKSixeoXPpUTjA.png)
