...
I worked with [Benjamin Mosior](https://medium.com/u/81e616c6fc2e) to write a script with a simple function: show me a random note from my Evernote collection. There’s long been [such a script](https://discussion.evernote.com/topic/18398-request-random-display-of-notes/?page=2#comment-290804) floating around on the Evernote forums, but with a catch: you couldn’t specify *stacks* (groupings of notebooks), only *individual* notebooks. This doesn’t work with a dynamic, responsive organizational system like I detailed in [P.A.R.A. I](https://fortelabs.com/the-p-a-r-a-method-a-universal-system-for-organizing-digital-information-75a9da8bfb37) and [II](https://fortelabs.com/p-a-r-a-ii-operations-manual-b78fbddcfd3c), because your notebooks should be constantly evolving and changing. It doesn’t work to have to go modify the code every time a notebook changes, is added, or moved to archives.
...
![](https://i0.wp.com/cdn-images-1.medium.com/max/800/1*wsRgPjEExz2egXe0caUegQ.png?w=900&ssl=1)
...
When I first installed this script, I figured it would become part of my [weekly review](https://fortelabs.com/the-weekly-review-is-an-operating-system-8e8e04f885ab). An infrequent, only occasionally useful exercise to remember notes I’d previously saved.
...
Second, randomly surfacing notes provides many, many more chances than usual to tweak, add to, or summarize notes. Using notes *opportunistically* requires that you encounter many such opportunities. Many of the notes that get surfaced I retitle, tag, move, or delete, which means I’m constantly pruning and curating my collection for my future self. Every interaction with my notes serves a [dual purpose](https://fortelabs.com/mood-as-extrapolation-engine-using-emotions-to-generate-momentum-65a2e5940aae): giving me ideas *now*, and giving me even more condensed ideas *in the future*. This is tremendously rewarding. Addicting even.
